...
describe TokenizedAddress do 
	...
	before :all do
		@t1a = TokenizedAddress.new(init_string: '7462 Denrock Ave. Los Angeles')
		@t1b = TokenizedAddress.new(init_string: '7462 Denrock Avenue Los Angeles')
		
		@t2a = TokenizedAddress.new(init_string: '240 Ofarrel St')
